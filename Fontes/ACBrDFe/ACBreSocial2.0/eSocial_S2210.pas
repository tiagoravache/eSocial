...
type
  ...
  private
    ...
    FtpCat: tpTpCat;
 //   FindCatParcial: tpSimNao;--removida na versão 2.1
...
//    property indCatParcial: tpSimNao read FindCatParcial write FindCatParcial; -- removido na versão 2.1
  ...
  public
    ...
    property codCNES: Integer read FcodCNES write FcodCNES;
    ...
    property dscLesao: string read FdscLesao write FdscLesao;
...
begin
  Gerador.wGrupo('cat');
   ...
   // Gerador.wCampo(tcStr, '', 'indCatParcial', 0, 0, 0, eSSimNaoToStr(self.Cat.indCatParcial)); -- removido na versão 2.1
...
begin
  ...
  begin
    Gerador.wGrupo('parteAtingida');
      Gerador.wCampo(tcStr, '', 'codParteAtingida  ', 0, 0, 0, self.Cat.ParteAtingida.Items[iContador].codParteAting);
