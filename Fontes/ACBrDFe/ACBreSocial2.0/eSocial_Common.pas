...
type
  ...
  private
    FId: string;
//    FVersao: string; - removido na verṣo 2.1
  published
    property Id: string read FId write FId;
//    property versao: string read FVersao write FVersao;
  end;
  ...
  private
    ...
    FdepIRRF: tpSimNao;
    FdepSF: tpSimNao;
   // FDepRPPS: tpSimNao;--removido na verṣo 2.1
  published
    constructor create; reintroduce;
    property tpDep: tpTpDep read FtpDep write FtpDep;
    property nmDep: string read FnmDep write FnmDep;
    ...
    property depIRRF: tpSimNao read FdepIRRF write FdepIRRF;
    property depSF: tpSimNao read FdepSF write FdepSF;
  //  property DepRPPS: tpSimNao read FDepRPPS write FDepRPPS; removido na verṣo 2.1
  end;
  ...
  private
    FtpProc : tpTpProc;
    FtpTrib : tpTpTributo;
    FnrProcJud: string;//em S1250 o campo ̩ nrProcJUD e em S1260 ̩ apenas nrProc - deixado nrProcJud para reutiliza̤̣o da classe
    FvrCPNRet: Double;
    FvrRatNRet: Double;
    FvrSenarNRet: Double;
    FvrCPSusp: Double;
